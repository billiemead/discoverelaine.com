...
<ul class="hc-ml3">
	...
	<li class="hc-mt3">
		...
		<ul class="hc-ml3">
			<li>
				<?php echo HCM::__('Adds a select list to quickly jump to a group.'); ?>
			</li>
			<li>
				<?php echo HCM::__('Default'); ?>: <em>0</em>
			</li>
			<li>
				<?php echo HCM::__('Possible options'); ?>: <em>0, 1</em>.
			</li>
	...
	<li class="hc-mt3">
		...
		<ul class="hc-ml3">
			<li>
				<?php echo HCM::__('Display the search form below the map.'); ?>
			</li>
