...
// exit;
	...
	// locate me
		...
		if( $locateMeLabel === NULL ){
			$locateMeLabel = 'Locate Me';
		}
		$locateMeLabel = HCM::__($locateMeLabel);
		...
		$myLocationLabel = HCM::__($myLocationLabel);
	...
	// more results link
		...
		$more_results_label = HCM::__($more_results_label);
