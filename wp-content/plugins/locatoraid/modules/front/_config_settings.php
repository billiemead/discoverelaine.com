...
$config['settings']['front:links_new_window'] = 1;
...
$config['settings']['front_text:submit_button'] = 'Search';
$config['settings']['front_text:search_field'] = 'Address or Zip Code';
$config['settings']['front_text:more_results'] = 'More Results';
$config['settings']['front_text:no_results'] = 'No Results';
$config['settings']['front_text:locate_me'] = 'Locate Me';
$config['settings']['front_text:my_location'] = 'My Location';
