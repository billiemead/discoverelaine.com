...
*/
	...
	*/
	function _clean_input_data($str)
	{
		...
		*/
		if (
			( ! hc_is_php('5.4') && get_magic_quotes_gpc() )
			OR // wordpress?
			( defined('WPINC') )
			)
		{
		...
		$str = hc_remove_invisible_characters($str);
	...
	*/
	...
	{
		return (php_sapi_name() === 'cli' OR defined('STDIN') OR ( isset($GLOBALS['NTS_CLI_REQUEST']) && $GLOBALS['NTS_CLI_REQUEST']));
	}
}
?>